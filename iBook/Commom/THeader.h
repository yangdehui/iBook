...
#define TTextMessageCell_Text_Width_Max (Screen_Width -144)
...
//custom cell
#define TCustomMessageCell_ReuseId @"TCustomMessageCell"
#define TCustomMessageCell_Height_Min (TMessageCell_Head_Size.height + 2 * TMessageCell_Padding)
#define TCustomMessageCell_Text_Width_Max (Screen_Width - 144)
#define TCustomMessageCell_Margin 12
//redEnvelope cell
#define TRedEnvelopeMessageCell_ReuseId @"TRedEnvelopeMessageCell"
...
//消息已读回执
#define TUIKitNotification_TIMMessageReceiptListener @"TUIKitNotification_TIMMessageReceiptListener"
//用户登录成功
#define TUIKitNotification_TIMUserLoginSuccess @"TUIKitNotification_TIMUserLoginSuccess"
//添加好友
...
//群组信息变更
#define TUIKitNotification_onGroupTipsEvent @"TUIKitNotification_onGroupTipsEvent"
//切换登录成功通知
#define TIMKitNotification_CheckLoginSuccess @"TIMKitNotification_CheckLoginSuccess"
// 网络状态改变
#define GKWYMUSIC_NETWORKCHANGENOTIFICATION     @"NetworkChangeNotification"
// 播放状态改变
#define GKWYMUSIC_PLAYSTATECHANGENOTIFICATION   @"playStateChangeNotification"
// 喜欢音乐
#define GKWYMUSIC_LOVEMUSICNOTIFICATION         @"loveMusicNotification"
// 播放数据改变
#define GKWYMUSIC_PLAYMUSICCHANGENOTIFICATION   @"playMusicCHangeNotification"
// 操作成功刷新发现页
#define TUIKitNotification_disCoverReloadData @"TUIKitNotification_disCoverReloadData"
